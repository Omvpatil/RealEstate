...
import { ArrowRight, Building2, Eye, Play, Users } from "lucide-react";
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto text-center max-w-6xl">
                    ...
                    <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
                        Your team&apos;s toolkit to stop configuring and start innovating. Securely build, deploy, and
                        scale the best construction experiences with BuildCraft.
                    </p>
                    ...
                    <div className="relative max-w-4xl mx-auto">
                        <div className="aspect-video bg-gradient-to-br from-muted to-muted/50 rounded-lg border border-border flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground">Interactive 3D Model Preview</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <Card className="text-center border-0 bg-transparent">
                            <CardContent className="pt-6">
                                <div className="text-3xl font-bold text-foreground mb-2">20 days</div>
                                <div className="text-muted-foreground">saved on daily builds.</div>
                        ...
                        <Card className="text-center border-0 bg-transparent">
                            <CardContent className="pt-6">
                                ...
                                <div className="text-muted-foreground">increase in efficiency.</div>
                        ...
                        <Card className="text-center border-0 bg-transparent">
                            <CardContent className="pt-6">
                                ...
                                <div className="text-muted-foreground">faster to build + deploy.</div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-foreground">Real-time 3D model collaboration</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="w-2 h-2 bg-accent rounded-full"></div>
                                    <span className="text-foreground">Progress tracking and milestone management</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="w-2 h-2 bg-accent rounded-full"></div>
                                    <span className="text-foreground">Change request workflow automation</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="aspect-square bg-gradient-to-br from-muted to-muted/50 rounded-lg border border-border flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-muted-foreground">Collaboration Interface</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 px-4 bg-primary text-primary-foreground">
                <div className="container mx-auto text-center">
                    <h2 className="text-4xl font-bold mb-6">Ready to transform your construction process?</h2>
                    <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                        Join thousands of builders and customers who trust BuildCraft for their construction projects.
                    </p>
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="flex items-center gap-2 mb-4 md:mb-0">
                            ...
                            <span className="text-xl font-bold text-foreground">BuildCraft</span>
                        </div>
